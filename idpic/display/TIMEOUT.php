...
// SQL query to fetch today's "OUT" entries with student and staff details
$sql = "
SELECT 
    dl.lid,
    dl.datetime, 
...
// Fetch the latest "OUT" entries with student and staff details
